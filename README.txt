...
________________________________________________
this file run on cifar100 image's, the third section is the part needed to be configuret by the user want's,it can be configuried to find the best activaion funcation ,
...
________________________________________________
same as before , but this time with the option to look specifc for each layer what is the best activaion funcation, 
and not a global one for all the layers, configuration at the sec section, run on cifar 100 data, 
use resnet9 neural network with the option to set a diffrent activaion funcation parameters for each of the 8 layers 
